...
from helx.kube.models import SecurityContext
...
class TestProbesInHelxappSpec:
    ...
    def test_template_port_string_resolved_to_service_port(self):
        ...
        from helx.app.models import ProbeSpec as AppProbeSpec
        from helx.registry.spec_builder import _convert_probe
