...
urlpatterns = [
    ...
    # url(r'^accounts/login/$', auth_views.login, {'template_name': 'No_login.html'}, name='login'),
    url(r'^accounts/login/$', auth_views.LoginView.as_view(template_name='accounts/No_login.html'), name='login'),
